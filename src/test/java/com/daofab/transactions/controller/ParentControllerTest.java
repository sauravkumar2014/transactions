...
import static com.daofab.transactions.validator.ParentSortByValidator.PROPERTY_NOT_FOUND_MESSAGE;
...
public class ParentControllerTest {
    ...
    void whenValidInput() throws Exception {
        ...
        ResponseEntity<String> actualJsonResponse = restTemplate.getForEntity(baseUrl + "/parents", String.class);
    ...
    @Test
    void whenWrongSortBy() {
        String expectedJsonResponse = "getPaginated.pageable: " + String.format(PROPERTY_NOT_FOUND_MESSAGE, "sender", "id");

        ResponseEntity<String> actualJsonResponse = restTemplate.getForEntity(baseUrl + "/parents?sort=sender", String.class);
